...
public class Post{
	...
	public int getJml_komentar() {
		return jml_komentar;
	}
	public void setJml_komentar(int jml_komentar) {
	...
	public String toString(){
		return "{id_post=" + id_post + ", msg=" + msg + ", id_pegawai =" + id_pegawai + ", nama=" + nama + ", gelar_belakang=" + gelar_belakang + ", kapan=" + kapan + ", parent_id=" + parent_id + ", jml_komentar=" + jml_komentar + ", request_status=" + request_status + "}";
	}
